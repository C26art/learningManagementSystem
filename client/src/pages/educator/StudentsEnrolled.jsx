...
const StudentsEnrolled = () => {
  ...
  return enrolledStudents ? (
    <div className='min-h-screen flex flex-col items-start justify-between md:p-8 p-4 md:pb-0 pt-8 pb-0'>
            ...
            {enrolledStudents.map((item, index) => (
              <tr key={index} className='border-b border-gray-500/20'>
                ...
                <td className='px-4 py-3 flex items-center space-x-3'>
                  <img src={item.student.imageUrl} alt="Student imageUrl" className='w-9 h-9 rounded-full' />
